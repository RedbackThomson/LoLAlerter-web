...
define("JSON", '/Elements/json');

/**
 * Configuration for the Twitch OAuth Authorization
 * Confidential - to be kept secret
 */
 /*
  * Development settings
  *	Configure::write('LoLAlert.Redirect', 'http://lolalerter.softcode.co:8080/');
  ...
  */
	Configure::write('LoLAlert.Redirect', 'http://lolalerter.softcode.co/');
